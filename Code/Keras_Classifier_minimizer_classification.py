...
k_mers_1 = np.load(data_path + "0_1000000_minimizers_k_9_m_3_file.npy")
...
k_mers_1 = np.load(data_path + "1000000_2000000_minimizers_k_9_m_3_file.npy")

for e in range(len(k_mers_1)):
    frequency_vector_read_final.append(k_mers_1[e])
    
k_mers_1 = np.load(data_path + "2000000_3000000_minimizers_k_9_m_3_file.npy")

for e in range(len(k_mers_1)):
    frequency_vector_read_final.append(k_mers_1[e])
    
k_mers_1 = np.load(data_path + "3000000_4072342_minimizers_k_9_m_3_file.npy")
...
EMBEDDING_DIM = 500
Memory_Units = 200
epochs_size = 20 # one epoch = one forward pass and one backward pass of all the training examples
